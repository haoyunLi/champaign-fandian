...
export type HistoryRoom = { id: string; title: string; status: string; created_at: string; deleted_at: string | null; winner_name: string | null; vote_count: number; order_count: number };
